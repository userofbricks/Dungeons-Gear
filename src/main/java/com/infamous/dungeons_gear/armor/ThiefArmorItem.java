...
import static com.infamous.dungeons_gear.items.ArmorList.SPIDER_ARMOR;
import static com.infamous.dungeons_gear.items.ArmorList.SPIDER_ARMOR_HOOD;
import static com.infamous.dungeons_gear.items.ArmorList.THIEF_ARMOR;
import static com.infamous.dungeons_gear.items.ArmorList.THIEF_ARMOR_HOOD;
...
public class ThiefArmorItem extends ArmorItem implements IArmor {
    ...
    public ThiefArmorItem(IArmorMaterial armorMaterial, EquipmentSlotType slotType, Properties properties, boolean unique) {
        ...
        builder.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new AttributeModifier(uuid, "Armor attack damage boost", 0.25D * 0.5D, AttributeModifier.Operation.MULTIPLY_BASE));
